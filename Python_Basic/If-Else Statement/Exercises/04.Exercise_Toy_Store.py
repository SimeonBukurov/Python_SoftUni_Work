...
toys_numbers = number_of_trucks + number_of_minions + number_of_teddy_bears + number_of_puzzles + \
               number_of_talking_dolls
if toys_numbers >= 50:
    order_sum -= order_sum * 0.25
rent = order_sum * 0.10
net_profit = order_sum - rent
diff = abs(net_profit - price_for_vacation)
if net_profit >= price_for_vacation:
